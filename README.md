...
## 보관 범위
이 대화에서 실제 파일을 확인한 **생성 이미지 24개**를 중복 없이 보존했습니다. 주요 에피소드 14편의 이미지 15개(단체사진의 이전 버전 1개 포함), 초기 만화 2개, 캐릭터·직업 참고 이미지 7개입니다. 주요 에피소드의 대화 원고/스토리 제안 14개도 함께 기록했습니다.
...
- 다음 새 만화는 015부터 시작합니다. 제작 기준과 파일 보존 방식은 [작업 안내](AGENTS.md)를 따릅니다.
