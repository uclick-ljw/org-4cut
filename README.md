...
## 보관 범위
현재 **에피소드 15편·생성 이미지 25개**를 보관합니다. 최초 복원본은 주요 에피소드 14편의 이미지 15개(단체사진의 이전 버전 1개 포함), 초기 만화 2개, 캐릭터·직업 참고 이미지 7개와 원고 14개입니다. 이후 제작한 015 「구매 승인」의 이미지·원고·생성 프롬프트를 추가했습니다.
